...
0. Конфигурируемый watcher + [https://www.browsersync.io/](BrowserSync)
...
`filterRegExp` - функция, для фильтрации подлежащих компиляции файлов. По умолчани не компилируются файлы начинающиеся с `_` либо лежащие в папках, начинающихся с `_`. Можно указать, чтобы их всех файлов компилировались в HTML только те, что лежат в папке './src/pages': 
